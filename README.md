...
| 🗳️ 候选 | [多格式](https://github.com/GongziTANG/mpvault/issues/2)、[筛选/合集](https://github.com/GongziTANG/mpvault/issues/3)、[视频音频与去重](https://github.com/GongziTANG/mpvault/issues/4) |
| 🗳️ 候选 | [增量订阅、定时备份与 RSS](https://github.com/GongziTANG/mpvault/issues/1) |
| 🗳️ 候选 | [Obsidian](https://github.com/GongziTANG/mpvault/issues/5)、[选择性 OCR](https://github.com/GongziTANG/mpvault/issues/6)、[语义搜索与带引用问答](https://github.com/GongziTANG/mpvault/issues/7) |
| 🗳️ 候选 | [互动数据](https://github.com/GongziTANG/mpvault/issues/9)、[本地界面/Docker/API](https://github.com/GongziTANG/mpvault/issues/8) |
